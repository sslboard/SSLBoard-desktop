...
- [ ] 1.1 Create new module `src-tauri/src/core/commands/dns_provider_validation.rs`
...
- [ ] 1.2 Create new module `src-tauri/src/core/commands/dns_provider_creation.rs`
...
- [ ] 1.3 Create new module `src-tauri/src/core/commands/dns_provider_management.rs`
...
- [ ] 1.4 Create new module `src-tauri/src/core/commands/dns_provider_testing.rs`
...
- [ ] 1.5 Refactor main `dns_providers.rs` to import and expose the new modules
...
- [ ] 2.1 Remove silent error handling in `dns_providers.rs:155`
...
- [ ] 2.2 Remove silent error handling in `legacy/acme_issuer.rs`
...
- [ ] 2.3 Fix unsafe error handling in `dns.rs:351`
...
- [ ] 2.4 Fix unsafe error handling in `lib.rs:71`
...
- [ ] 6.3 Extract validation helpers
...
- [ ] 7.1 Implement connection pooling for DNS APIs
  - Add `reqwest` client reuse across requests
  - Configure appropriate connection limits
  - Add connection timeout handling

- [ ] 7.2 Remove sensitive data from debug logs
...
- [ ] 8.1 Update existing tests to work with refactored code
  - Fix import paths in test modules
  - Update function signatures if changed
  - Ensure test coverage remains intact

- [ ] 8.2 Add tests for error handling improvements
  - Test proper error propagation
  - Verify logging behavior
  - Test timeout and cancellation scenarios

- [ ] 8.3 Validate refactoring with `cargo check` and `cargo test`
