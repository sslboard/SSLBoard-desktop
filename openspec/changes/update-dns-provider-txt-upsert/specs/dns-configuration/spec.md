...
#### Scenario: TXT content is quoted
- **WHEN** the Cloudflare adapter writes a TXT record
- **THEN** the system SHALL send the TXT content to Cloudflare wrapped in quotes
...
#### Scenario: TXT content is quoted
- **WHEN** the DigitalOcean adapter writes a TXT record
- **THEN** the system SHALL send the TXT content to DigitalOcean wrapped in quotes
...
#### Scenario: TXT content is quoted
- **WHEN** the Route 53 adapter writes a TXT record
- **THEN** the system SHALL send the TXT content to Route 53 wrapped in quotes
